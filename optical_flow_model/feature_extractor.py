...
try:
    ...
    # Minimal timm-compatible fallbacks to keep flow guidance self-contained.
    def to_2tuple(x):
...
try:
    ...
    raise ImportError(
        "mamba_ssm is required for optical_flow_model.feature_extractor. "
        "Install mamba-ssm compatible with your torch/cuda version."
    ) from exc
